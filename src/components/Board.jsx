...
function Board(props) {
    return (
        <div className="board">
            <svg className="boardSVG" width="300" height="300" viewBox="0 0 350 350" fill="none"
                xmlns="http://www.w3.org/2000/svg" onClick={(e) => props.onClick(e)}>
            ...
            <Boxes board={props.gameState.board} width="100px" height="100px" boxOnClick={props.boxOnClick}/>
        </div>
    )
}

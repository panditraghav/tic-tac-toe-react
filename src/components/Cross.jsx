...
function Cross() {
    return (
        <div className="cross">
            <svg className="first" width="75" height="73" viewBox="0 0 75 73" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="second" width="75" height="73" viewBox="0 0 75 73" fill="none"
